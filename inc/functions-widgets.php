...
class widget_download extends WP_Widget
{
    ...
    public function widget($args, $instance)
    {
        ...
        $downArr   = get_post_meta($post->ID, 'wppay_down', true);
            ...
            if ($wppay->is_paid() || $type == 4) {
                ...
                if ($downArr) {
                    foreach ($downArr as $key => $value) {
                        $action_url = get_stylesheet_directory_uri() . '/action/download.php?url=';
...
class widget_asst extends WP_Widget
{
    ...
    public function form($instance)
    {
        $defaults = array(
            ...
            'code'    => '<a href="https://github.com/AdFate/Rizhuti" target="_blank"><img src="' . get_stylesheet_directory_uri() . '/img/wpay_ad.jpg"></a>',
            'nophone' => '',
        );
...
class widget_textasst extends WP_Widget
{
    ...
    public function form($instance)
    {
        $defaults = array(
            ...
            'link'    => 'https://github.com/AdFate/Rizhuti',
            'style'   => 'style01',
            'blank'   => 'on',
        );
        $instance = wp_parse_args((array) $instance, $defaults);
